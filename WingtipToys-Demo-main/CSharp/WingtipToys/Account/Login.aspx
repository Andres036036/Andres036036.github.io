<%@ Page Title="Iniciar sesión" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" 
    CodeBehind="Login.aspx.cs" Inherits="WingtipToys.Account.Login" Async="true" %>
    ...
    <div class="row">
        <div class="col-md-8">
            <section id="loginForm">
                ...
                <p>
                    <asp:HyperLink runat="server" ID="RegisterHyperLink" ViewStateMode="Disabled">Registrarse como nuevo usuario</asp:HyperLink>
                </p>

                <p>
                    <%-- Habilita esto una vez que tengas la confirmación de cuenta activada para la función de restablecimiento de contraseña

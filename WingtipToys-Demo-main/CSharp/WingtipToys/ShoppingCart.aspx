...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:GridView ID="CartList" runat="server" AutoGenerateColumns="False" ShowFooter="True" GridLines="Vertical" CellPadding="4"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Product.ProductName" HeaderText="Nombre del producto" />
    ...
    <div>
        <p></p>
        <strong>
            <asp:Label ID="LabelTotalText" runat="server" Text="Total del pedido: "></asp:Label>
        ...
        <tr>
            ...
            <td>
                <asp:ImageButton ID="CheckoutImageBtn" runat="server"
                    ImageUrl="https://www.paypalobjects.com/es_XC/i/btn/btn_xpressCheckout.gif"

...
public class NVPAPICaller
{
  ...
  public string APIUsername = "sb-shthq47563789_api1.business.example.com";
  private string APIPassword = "QP2J72MXV75UVXJE";
  private string APISignature = "AmD7.hNwn0nh7PG.DZkiL5ddZhgCAxaeuvvtrrgtMC-h5QR-Y94Of6rs";
  ...
  private const int Timeout = 15000;
    private decimal ConvertCOPtoUSD(decimal cop)
    {
        decimal tasa = 4000m; // puedes ajustar la tasa cuando quieras
        decimal usd = cop / tasa;
  ...
  public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
  {
    ...
    string returnURL = "https://localhost:44325/Checkout/CheckoutReview.aspx";
    string cancelURL = "https://localhost:44325/Checkout/CheckoutCancel.aspx";
